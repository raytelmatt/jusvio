...
test('Create a Task in a Matter', async ({ page }) => {
  ...
  // Use provided credentials for www.jusivo.com
  const email = 'iahmatt@icloud.com';
  const password = 'Kb5teh04';
  ...
  // Wait for sidebar to appear which indicates successful login
