...
- generic [ref=e10]:
  ...
  - generic [ref=e52]:
    ...
    - generic [ref=e60]:
      - img [ref=e61]
      - generic [ref=e63]: Unable to connect to authentication servers. This may be due to network issues or firewall restrictions. Please try again or contact support if the problem persists.
  ...
  - generic [ref=e70]:
    ...
    - generic [ref=e72]:
      - paragraph [ref=e73]: Criminal Defense • Personal Injury • SSD Cases
      - generic [ref=e74]:
        - link "General Case Intake" [ref=e75] [cursor=pointer]:
          - /url: /intake/new
          - img [ref=e76] [cursor=pointer]
          - text: General Case Intake
        - link "Criminal Defense Intake" [ref=e81] [cursor=pointer]:
          - /url: /intake/criminal
          - img [ref=e82] [cursor=pointer]
          - text: Criminal Defense Intake
    - generic [ref=e86]: © 2025 Matthew R. Ray - All Rights Reserved
```