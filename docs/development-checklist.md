...
- [ ] **Branch Naming**: Branch follows convention `username/issue-XXX-descriptive-name`
- [ ] **Commit Messages**: Commits reference issue ID
...
### 1. Pull Request
- [ ] **PR Description**: Clear description with issue reference
...
- [ ] **Issue Reference**: PR must reference issue
...
### Stop Development If:
- [ ] **No Issue**: Development started without issue
...
**Remember**: This checklist is a tool to ensure quality and proper tracking. Adapt it to your specific needs while maintaining the core principle of documenting all changes.
