          ...
          <div className="bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 p-8 shadow-2xl relative">
            ...
            <div className="mt-8 text-center space-y-4">
              <button
                ...
                className="w-full bg-white text-gray-800 font-semibold py-3 px-6 rounded-2xl border border-white/40 hover:bg-white/90 transition-all duration-300 shadow-md"
              >
