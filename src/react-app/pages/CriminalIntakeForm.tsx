  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const clientData = {
        ...
        phones: (formData.mobile_phone || formData.home_phone || formData.work_phone) ? 
          JSON.stringify([formData.mobile_phone || formData.home_phone || formData.work_phone]) : null,
          ...
          {currentStep === 1 && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label htmlFor="ssn_last4" className="block text-sm font-medium text-gray-700 mb-1">
                    SSN (Last 4 digits)
                  </label>
                  <input
                    id="ssn_last4"
                ...
                <div>
                  <label htmlFor="race_ethnicity" className="block text-sm font-medium text-gray-700 mb-1">
                    Race/Ethnicity
                  </label>
                  <select
                    id="race_ethnicity"
                ...
                <div>
                  <label htmlFor="citizenship_status" className="block text-sm font-medium text-gray-700 mb-1">
                    Citizenship Status
                  </label>
                  <select
